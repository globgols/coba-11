      ...
      <form action="{{ route('register') }}" method="POST" class="mx-auto max-w-[345px] w-full p-6 bg-white rounded-3xl mt-auto" id="deliveryForm">
        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-2.5">
            ...
            <input style="background-image: url('{{ asset('assets/svgs/ic-profile.svg')}}')" type="text" name="name" 
            id="fullname__"
          ...
          <div class="flex flex-col gap-2.5">
            ...
            <input type="email" name="email" id="email__"
              class="form-input bg-[url('{{asset('assets/svgs/ic-email.svg')}}')]" placeholder="Your email address">
          </div>
          <!-- Password -->
          <div class="flex flex-col gap-2.5">
            <label for="password" class="text-base font-semibold">Password</label>
            <input style="background-image: url('{{asset('assets/svgs/ic-lock.svg')}}')" type="password" 
            name="password_confirmation" id="password__"
          ...
          <div class="flex flex-col gap-2.5">
            ...
            <input style="background-image: url('{{asset('assets/svgs/ic-lock.svg')}}')" type="password" 
            name="password" id="confirm-password__"
              class="form-input" placeholder="Protect your password">
          </div>
          <button type="button" class="inline-flex text-white font-bold text-base bg-primary rounded-full whitespace-nowrap px-[30px] py-3 justify-center items-center" onclick="window.location.href='./login.html'">
            Create My Account
          </button>
        </div>
      </form>
