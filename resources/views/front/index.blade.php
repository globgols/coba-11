	...
	<body>
		...
		<section class="wrapper flex flex-col gap-2.5 items-center justify-center">
			...
			<form action="" method="POST" id="searchForm" class="w-full">
				...
				name="search" id="searchProduct"
					class="block w-full py-3.5 pl-4 pr-10 rounded-[50px] font-semibold placeholder:text-grey 
					placeholder:font-normal text-black text-base bg-no-repeat bg-[calc(100%-16px)] focus:ring-2 
		...
		<section class="wrapper">
			<div style="background-image: url('{{ asset('assets/svgs/pipeline.svg')}}')"
				class="flex justify-between gap-5 items-center bg-lilac py-3.5 px-4 rounded-2xl relative bg-left 
